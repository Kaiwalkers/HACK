...
from main.views import GenreListView, MoviesViewSet
...
schema_view = get_schema_view(
   openapi.Info(
      title="HACK API",
      default_version='v1',
      description="HACK THIS WORLD",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="asyrbekov98@gmail.com"),
      license=openapi.License(name="KAI License"),
   ),
   public=True,
)
